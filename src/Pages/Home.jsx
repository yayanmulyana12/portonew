...
const WORDS = ["Student of Universitas Singaperbangsa", "informatics"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/yayanmulyana12/" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/yayan-mulyana-1bb288374/" },
  { icon: Instagram, link: "https://www.instagram.com/yn.60fps/" }
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/2d8c8b2f-3547-416d-ae2e-414246d31e0f/EfVEu4A5pG.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
